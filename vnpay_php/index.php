    ...
    <body>
        ...
        <div class="container">
            <div class="header clearfix">
               <img src="https://sandbox.vnpayment.vn/paymentv2/Images/brands/logo.svg" alt="">
            </div>
            ...
            <div class="table-responsive">
                <form action="./vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <button type="submit" name="redirect" class="btn btn-primary" id="btnPopup">Thanh toán </button>
